...
from select_gnn_upsampling import SELECT_GNN
...
def main(training_file, dev_file, test_file, graph_type=None, net=None, epochs=None, patience=None, batch_size=None,
    ...
    train_dataset = socnav2d.SocNavDataset(training_file, mode='train', alt=graph_type, raw_dir='./')
    print('Loading dev set...')
    valid_dataset = socnav2d.SocNavDataset(dev_file, mode='valid', alt=graph_type, raw_dir='./')
    print('Loading test set...')
    test_dataset = socnav2d.SocNavDataset(test_file, mode='valid', alt=graph_type, raw_dir='./')
