...
The next video shows real time map generation in a sequence of scenarios created with [SocNavGym](https://github.com/gnns4hri/SocNavGym/).

![Demo video showing maps generated by SNGNN2D-v2 from scenarios of SocNavGym](resources/sngnn2D-v2_demo_video.mp4)
